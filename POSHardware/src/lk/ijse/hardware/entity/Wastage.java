...
public class Wastage implements SuperEntity{
    ...
    public Wastage(String wastageId, String arthur, String reason, int qty, double cost, Date date, Time time, String itemCode) {
